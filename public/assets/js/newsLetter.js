...
window._show_thank_you = function(id, message, trackcmp_url, email) {
    var form = document.getElementById('_form_' + id + '_'), thank_you = form.querySelector(id == "44" ? "._form-thank-you-newsletter" : "._form-thank-you");
    ...
    if (id != "44") {
        ...
        window.location.href =`/cairo/thank-you/${name}`;
