    ...
    render(): React.ReactNode {
        ...
        return (
            <React.Fragment>
                ...
                <ContentMainComponent track="Register" heading="REGISTER" subheading="YOUR INTEREST">
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <form method="POST" action="//ac.strategic.ae/proc.php" id="_form_305_" className="_form _form_305 _inline-form  _dark" noValidate>
                                        ...
                                        <input type="hidden" name="field[38]" value="DIFAC 2025 Register Interest" />
                                        <div className="_form-content">
                                            ...
                                            <div className="_form_element _field159 _full_width">
