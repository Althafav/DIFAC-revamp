                            ...
                            <div className="row">
                                <div className="col-12">
                                    <form method="POST" action="//ac.strategic.ae/proc.php" id="_form_305_" className="_form _form_305 _inline-form  _dark" noValidate>
                                        ...
                                        <input type="hidden" name="field[38]" value="DIFAC 2025 Book Your Stand" />
                                        <div className="_form-content">
                                            ...
                                            <div className="_form_element _field159 _full_width d-none">
                                                ...
                                                <fieldset className="_form-fieldset">
                                                    ...
                                                    <div className="_row _checkbox-radio">
                                                        <input id="field_159Exhibitor" type="checkbox" name="field[159][]" checked disabled value="Exhibitor" />
                                                        <span>
                                                            <label className="checkbox-label">
                                                                Exhibitor
                                                            </label>
                                                    ...
                                                    <div className="_row _checkbox-radio">
                                                        <input id="field_159Media Partner" type="checkbox" name="field[159][]" value="Media Partner" />
                                                        <span>
                                                            <label className="checkbox-label">
                                                                Media Partner
                                                            </label>
                                            ...
                                            <div style={{ display: "none" }}>
                                                <div className="_form_element _x18620027 _full_width ">
                                                    <fieldset className="_form-fieldset">
                                                        ...
                                                        <div className="_row _checkbox-radio">
                                                            <input id="field_278Yes" type="checkbox" name="field[278][]" value="Yes" checked />
                                                            <span>
                                                                <label>
                                                                    Yes
                                                                </label>
                                                        ...
                                                        <div className="_row _checkbox-radio">
                                                            <input id="field_278No" type="checkbox" name="field[278][]" value="No" />
                                                            <span>
                                                                <label>
                                                                    No
                                                                </label>
