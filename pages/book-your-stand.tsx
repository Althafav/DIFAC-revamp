    ...
    render(): React.ReactNode {
        ...
        return (
            <React.Fragment>
                ...
                <ContentMainComponent track="Book Your Stand" heading="BOOK" subheading="YOUR STAND">
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <form method="POST" action="//ac.strategic.ae/proc.php" id="_form_404_" className="_form _form_404 _inline-form  _dark" noValidate>
                                        ...
                                        <input type="hidden" name="or" value="cb772643bff013f5af9af9c444cd741d" />
                                        <input id="emailExist" hidden type="checkbox" />
                                        <input id="emailValidate" hidden type="checkbox" />
                                        <input type="hidden" name="field[38]" value="CIFAC 2024 Book Your Stand" />
                                        <div className="_form-content">
                                            ...
                                            <div className="_form_element _x04229842 _full_width d-none" >
                                                <fieldset className="_form-fieldset">
                                                    ...
                                                    <div className="_row _checkbox-radio">
                                                        <input id="field_246Exhibitor" type="checkbox" name="field[246][]" value="Exhibitor" checked className="any" required />
                                                        <span>
                                            ...
                                            <div className="row m-t-15">
                                                <div className="col-12 p-0 d-none">
                                                    <input id="bookstand" type="checkbox" checked disabled />
                                                    <span>
                                                        <label className="checkbox-label">
                                                            Book your Stand
                                                        </label>
                                            ...
                                            <div style={{ display: "none" }}>
                                                <div className="_form_element _x68081836 _full_width " >
                                                    <fieldset className="_form-fieldset">
                                                        ...
                                                        <div className="_row _checkbox-radio">
                                                            <input id="field_279Yes" type="checkbox" name="field[279][]" value="Yes" disabled checked />
                                                            <span>
                                                                <label>
                                                                    Yes
                                                                </label>
                                                        ...
                                                        <div className="_row _checkbox-radio">
                                                            <input id="field_279No" type="checkbox" name="field[279][]" value="No" />
                                                            <span>
                                                                <label>
                                                                    No
                                                                </label>
